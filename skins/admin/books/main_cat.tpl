<div class="goods" style="padding-top:20px; padding-bottom:20px;">
  <div class="goods_add"><a href="/admin/goods/add_cat">ДОБАВИТЬ КАТЕГОРИЮ</a></div>	
	  <?php if(isset($info)) { ?>
        ...
        <table class="table">
          ...
          <?php while($row = $res->fetch_assoc()) { ?>
            <tr>
              ...
              <td><a href="/admin/goods/main_cat?action=delete&id=<?php echo $row['id']; ?>">
                <img src="/skins/admin/img/publish_r.png" width="16" height="16"></a>
              </td>
              <!--Делаем ссылку и передаем параметры для редактирования-->
              <td><a href="/admin/goods/edit_cat?id=<?php echo $row['id']; ?>">
